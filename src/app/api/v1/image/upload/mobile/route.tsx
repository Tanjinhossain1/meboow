...
const uploadDir = path.join(process.cwd(), 'public',`${process.env.IMAGES_FILE_DIRECTORY}`, 'mobiles', 'images');
...
export async function POST(req: NextRequest) {
  ...
  const imageUrl = `/${process.env.IMAGES_FILE_DIRECTORY}/mobiles/images/${uniqueFileName}`;
